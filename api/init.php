...
$sess_name  = defined("SESS_NAME") ? SESS_NAME : 'YP_ID';
$sess       = new cls_session($db, $yp->table('sessions'), $yp->table('sessions_data'), $sess_name);
