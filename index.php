 ...
 * ============================================================================
 * $Author: prince $
 * $Id: index.php 17063 2010-03-25 06:35:46Z prince $
*/
...
/* 修改 by demo.coolhong.com 今 天 优 品 多 商 户 系 统 q q 1 2 0 0 2 9 1 2 1 end */
}
/*------------------------------------------------------ */
//-- 
/*------------------------------------------------------ */
...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
	...
	$smarty->assign('show_index_street',   $_CFG['show_index_street']);   //20171013 prince qq120029121
	$smarty->assign('show_index_recommend',   $_CFG['show_index_recommend']);   //20171013 prince qq120029121
    ...
    {
        $sql = 'SELECT ad_type, content, url FROM ' . $yp->table("ad_custom") . ' WHERE ad_status = 1';
...
//$smarty->assign('index_total',get_index_total());  //销售明细
//$smarty->assign('index_list',get_index_order_list(20));//销售列表
