...
{ 
$sql="SELECT comment_rank,count(*) AS score_count FROM ".$GLOBALS['yp']->table('comment') ." WHERE comment_type='0' and id_value='$goods_id' and status='1' and parent_id='0' group by comment_rank";
