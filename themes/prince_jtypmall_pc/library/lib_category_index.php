...
//    $limit_num=10;
    $limit_num = $GLOBALS['db']->getOne(
        "SELECT show_goods_num FROM " . $GLOBALS['yp']->table("category") . "WHERE cat_id =" . $row['cat_id']);
...
{ 
$topcat_info = $GLOBALS['db']->getRow('SELECT cat_name, cat_index_rightad FROM '.$GLOBALS['yp']->table('category') . 
" WHERE cat_id = '$cat_id'"); 
