...
Page({
    ...
    var syskey = getApp().globalData.syskey;//寒冰 20170826


    server.getJSON('/User/getCouponList/user_id/' + user_id + "/page/" + page + "/type/" + cType + "/syskey/" + syskey,function(res){
