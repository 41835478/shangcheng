...
Page({
    ...
    sort: [['goods_id-desc', 'goods_id-asc'], ['shop_price-desc', 'shop_price-asc'], ['ghost_count-desc', 'ghost_count-asc'], ['click_count-desc', 'click_count-asc']],//20170830
		goods: [],
		empty:false
	},
	search:function(e){
    ...
    server.getJSON('/goods/search/keywords/' + keywords + "/p/" + page + "/sort/" + gsort + "/sort_asc/" + asc + "/syskey/" + syskey,function(res){
...
if(ms.length == 0)
    ...
    server.getJSON('/Goods/goodsList/id/' + category + "/sort/" + sortArray[0] + "/sort_asc/" + sortArray[1] + "/p/" + pageIndex + "/syskey/" + syskey,function(res){
