...
Page({
  ...
  buy: function () {
    ...
    var syskey = app.globalData.syskey;//20170811

    var user_id = "0"
    if (app.globalData.login)
      user_id = app.globalData.userInfo.user_id

    server.getJSON('/Cart/addCart', { syskey: syskey,goods_id: goods_id, goods_spec: goods_spec, session_id: session_id, goods_num: goods_num, user_id: user_id }, function (res) {
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      success: function (res) {
        server.postJSON('/Share/getShare/user_id/' + user_id + '/type/Goods', { user_id: user_id, open_id: open_id, syskey: syskey }, function (res) {
