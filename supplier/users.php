...
function action_insert ()
{
	...
	$other['supplier_id'] = $_SESSION['supplier_id'] ? $_SESSION['supplier_id'] : '0';
...
function action_edit ()
{
	...
	$sql = "SELECT u.user_name, u.sex, u.birthday, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money, u.credit_line, u.parent_id, u2.user_name as parent_username, u.qq, u.msn, u.office_phone, u.home_phone, u.mobile_phone" . " FROM " . $yp->table('users') . " u LEFT JOIN " . $yp->table('users') . " u2 ON u.parent_id = u2.user_id WHERE u.user_id='$_GET[id]'";
    ...
    u.office_phone, u.home_phone, u.mobile_phone,u.real_name,u.card,u.face_card,u.back_card,u.country,u.province,u.city,u.district,u.address,u.status " . " FROM " . $yp->table('users') . " u LEFT JOIN " . $yp->table('users') . " u2 ON u.parent_id = u2.user_id WHERE u.supplier_id='$_SESSION[supplier_id]' AND u.user_id='$_GET[id]'";
	/* 代码增加2014-12-23 by demo.coolhong.com 今 天 优 品 多 商 户 系 统 q q 1 2 0 0 2 9 1 2 1 _end */
...
function action_remove ()
{
	...
	/* 检查权限 */
	admin_priv('users_drop');
	$sql = "SELECT * FROM " . $yp->table('users') . " WHERE user_id = " . $_GET['id'] . " AND supplier_id = " . $_SESSION['supplier_id'] ;
...
function user_list ()
{
	...
	if($result === false)
	{
		...
		$ex_where = " WHERE supplier_id = '$supplier_id'";
		if($filter['keywords'])
		{
		...
		// reg_time ".
		$sql = "SELECT user_id, user_name, email, mobile_phone, is_validated, validated, user_money, frozen_money, rank_points, pay_points, status, reg_time, froms,headimg,nickname ".  //20160926 by prince 
		        /* 代码增加2014-12-23 by demo.coolhong.com 今 天 优 品 多 商 户 系 统 q q 1 2 0 0 2 9 1 2 1  _end  */
