 ...
 * ==========================================================
 * $Author: PRINCE $
 * $Id: email_list.php 17217 2017-04-01 06:29:08Z PRINCE $
 */
...
{
    $sql = "SELECT email FROM " . $yp->table('email_list') . "WHERE stat = 1";
...
elseif ($_REQUEST['act'] == 'batch_remove')
{
    ...
    $sql = "DELETE FROM " . $yp->table('email_list') .
...
elseif ($_REQUEST['act'] == 'batch_unremove')
{
    ...
    $sql = "UPDATE " . $yp->table('email_list') .
...
function get_email_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT COUNT(*) FROM " . $GLOBALS['yp']->table('email_list');
        ...
        $sql = "SELECT * FROM " . $GLOBALS['yp']->table('email_list') .
