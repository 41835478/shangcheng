...
/**
 * QQ120029121 网店信息管理页面
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: shopinfo.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
if ($_REQUEST['act'] == 'insert')
{
    ...
    /* 插入数据 */
    $add_time = gmtime();
    $sql = "INSERT INTO ".$yp->table('article')."(title, cat_id, content, add_time) VALUES('$_POST[title]', '0', '$_POST[FCKeditor1]','$add_time' )";
    $db->query($sql);
...
if ($_REQUEST['act'] == 'edit')
{
    ...
    /* 取得文章数据 */
    $sql = "SELECT article_id, title, content FROM ".$yp->table('article')."WHERE article_id =".$_REQUEST['id'];
