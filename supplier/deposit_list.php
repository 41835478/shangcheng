...
{    
     ...
     if ($result === false)
     {
		 ...
		 $sql = "SELECT COUNT(*) FROM " .$GLOBALS['yp']->table('affiliate_log') ." as d inner join " . $GLOBALS['yp']->table('users') . " as u on d.user_id = u.user_id where u.supplier_id='$supplier_id' AND d.separate_type=4 " . $ex_where;
		 ...
		 $arr = array();
		 $sql = "SELECT d.* FROM " .$GLOBALS['yp']->table('affiliate_log') ." as d inner join " . $GLOBALS['yp']->table('users') . " as u on d.user_id = u.user_id where u.supplier_id='$supplier_id' AND d.separate_type=4 " . $ex_where . " order by time desc";
