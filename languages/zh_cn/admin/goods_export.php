...
// 批量上传商品的字段
$_LANG['export_jtypmall'] = '导出到JTYPmall数据格式';
$_LANG['jtypmall']['goods_name'] = '商品名称';
$_LANG['jtypmall']['goods_sn'] = '商品货号';
$_LANG['jtypmall']['brand_name'] = '商品品牌';   // 需要转换成brand_id
$_LANG['jtypmall']['market_price'] = '市场售价';
$_LANG['jtypmall']['shop_price'] = '本店售价';
$_LANG['jtypmall']['integral'] = '积分购买额度';
$_LANG['jtypmall']['original_img'] = '商品原始图';
$_LANG['jtypmall']['goods_img'] = '商品图片';
$_LANG['jtypmall']['goods_thumb'] = '商品缩略图';
$_LANG['jtypmall']['keywords'] = '商品关键词';
$_LANG['jtypmall']['goods_brief'] = '简单描述';
$_LANG['jtypmall']['goods_desc'] = '详细描述';
$_LANG['jtypmall']['goods_weight'] = '商品重量（kg）';
$_LANG['jtypmall']['goods_number'] = '库存数量';
$_LANG['jtypmall']['warn_number'] = '库存警告数量';
$_LANG['jtypmall']['is_best'] = '是否精品';
$_LANG['jtypmall']['is_new'] = '是否新品';
$_LANG['jtypmall']['is_hot'] = '是否热销';
$_LANG['jtypmall']['is_on_sale'] = '是否上架';
$_LANG['jtypmall']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['jtypmall']['is_real'] = '是否实体商品';
