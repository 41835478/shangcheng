...
$_LANG['integral_min'] = '成长值下限';
$_LANG['integral_max'] = '成长值上限';
...
$_LANG['js_languages']['integral_min_invalid'] = '您没有输入成长值下限或者成长值下限不是一个整数。';
$_LANG['js_languages']['integral_max_invalid'] = '您没有输入成长值上限或者成长值上限不是一个整数。';
$_LANG['js_languages']['discount_invalid'] = '您没有输入折扣率或者折扣率无效。';
$_LANG['js_languages']['integral_max_small'] = '成长值上限必须大于成长值下限。';
