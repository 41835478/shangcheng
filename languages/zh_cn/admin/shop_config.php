...
$_LANG['cfg_desc']['shop_url'] = '商店绑定域名，包含"http://"或含"https://"  如：http://demo.coolhong.com/';
...
//20171013 start
$_LANG['cfg_name']['show_index_street'] = '首页是否显示店铺街模块';
$_LANG['cfg_range']['show_index_street'][1] = '是';
$_LANG['cfg_range']['show_index_street'][0] = '否';

$_LANG['cfg_name']['show_index_recommend'] = '首页是否显示商品推荐模块';
$_LANG['cfg_range']['show_index_recommend'][1] = '是';
$_LANG['cfg_range']['show_index_recommend'][0] = '否';
//20171013 end
