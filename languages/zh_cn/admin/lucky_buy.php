...
/**
 * QQ120029121 管理中心云购商品语言文件
 * ============================================================================
 * 网站地址: http://demo.coolhong.com；
 * ============================================================================
 * $Author: refengkeji $
 * $Id: lucky_buy.php 17217 2016-01-01 15:29:08Z refengkeji weixin: rfkjwx$
*/

/* 当前页面标题及可用链接名称 */
$_LANG['lucky_buy_list'] = '云购活动列表';
$_LANG['add_lucky_buy'] = '添加云购活动';
$_LANG['edit_lucky_buy'] = '编辑云购活动';
...
$_LANG['label_restrict_amount'] = '活动数量：';
$_LANG['notice_restrict_amount']= '中奖者达到此数量，活动自动结束。0表示没有数量限制。';
...
$_LANG['error_lucky_buy'] = '您要操作的云购活动不存在';
...
$_LANG['cancel_order_reason'] = '云购失败';
$_LANG['js_languages']['succeed_confirm'] = '此操作不可逆，您确定要设置该云购活动成功吗？';
$_LANG['js_languages']['fail_confirm'] = '此操作不可逆，您确定要设置该云购活动失败吗？';
$_LANG['button_mail'] = '发送邮件';
$_LANG['notice_mail'] = '（通知客户付清余款，以便发货）';
$_LANG['mail_result'] = '该云购活动共有 %s 个有效订单，成功发送了 %s 封邮件。';
$_LANG['invalid_time'] = '您输入了一个无效的云购时间。';

$_LANG['add_success'] = '添加云购活动成功。';
$_LANG['edit_success'] = '编辑云购活动成功。';
$_LANG['back_list'] = '返回云购活动列表。';
$_LANG['continue_add'] = '继续添加云购活动。';

/* 添加/编辑活动提交 */
$_LANG['error_goods_null'] = '您没有选择云购商品！';
$_LANG['error_goods_exist'] = '您选择的商品目前有一个云购活动正在进行！';
$_LANG['error_price_ladder'] = '您没有输入有效的价格阶梯！';
$_LANG['error_restrict_amount'] = '限购数量不能小于价格阶梯中的最大数量';

$_LANG['js_languages']['error_goods_null'] = '您没有选择云购商品！';
...
/* 删除云购活动 */
$_LANG['js_languages']['batch_drop_confirm'] = '您确定要删除选定的云购活动吗？';
$_LANG['error_exist_order'] = '该云购活动已经有订单，不能删除！';
$_LANG['batch_drop_success'] = '成功删除了 %s 条云购活动记录（已经有订单的云购活动不能删除）。';
$_LANG['no_select_lucky_buy'] = '您现在没有云购活动记录！';

/* 操作日志 */
$_LANG['log_action']['lucky_buy'] = '云购商品';
