...
$_LANG['cfg_name']['shop_name'] = '店铺名称';
$_LANG['cfg_name']['shop_url'] = '系统域名';
$_LANG['cfg_name']['shop_title'] = '系统标题';
$_LANG['cfg_name']['shop_website'] = '系统网址';
$_LANG['cfg_name']['shop_desc'] = '系统描述';
$_LANG['cfg_name']['shop_keywords'] = '搜索关键词';
...
$_LANG['cfg_name']['shop_notice'] = '系统公告';
$_LANG['cfg_name']['shop_index_num'] = '系统首页商品数量';
...
$_LANG['cfg_name']['close_comment'] = '关闭系统的原因';
...
$_LANG['cfg_name']['shop_logo'] = '系统 Logo';
...
$_LANG['cfg_desc']['shop_title'] = '系统的标题将显示在浏览器的标题栏';
$_LANG['cfg_desc']['shop_keywords'] = '请在每个关键词之间使用半角逗号（,）分隔。';
$_LANG['cfg_desc']['shop_url'] = '系统绑定域名，包含"http://"或含"https://"  如：http://demo.coolhong.com/';
...
$_LANG['cfg_desc']['shop_notice'] = '以上内容将显示在首页系统公告中,注意控制公告内容长度不要超过公告显示区域大小。';
...
$_LANG['cfg_desc']['send_service_email'] = '基本信息中的客服邮件地址不为空时，该选项有效。';
...
$_LANG['cfg_desc']['erweima_wapurl']      = ' 输入格式：http://或https://您的域名/mobile/goods.php?id={id}<br>例如：https://newdemo.coolhong.com/mobile/goods.php?id={id}';
...
$_LANG['cfg_desc']['what_sms'] = '没有账号？<a target="blank" href="http://yunsms.cn">马上注册云短信</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="blank" href="http://www.smsbao.com">马上注册短信宝</a></a>';

$_LANG['cfg_name']['dx_user_name'] = '短信服务账户';
$_LANG['cfg_desc']['dx_user_name'] = '短信服务商提供的供系统发送短信所需要的账户';

$_LANG['cfg_name']['dx_pass_word'] = '短信服务密码';
$_LANG['cfg_desc']['dx_pass_word'] = '短信服务商提供的供系统发送短信所需要的密码';

$_LANG['cfg_name']['sms_shop_mobile'] = '商家的手机号码';
$_LANG['cfg_desc']['sms_shop_mobile'] = '用于接收新订单提醒手机号码';
...
$_LANG['cfg_name']['sms_register'] = '通用验证码模板';//201700803
...
$_LANG['cfg_name']['sms_user_money_change_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['sms_user_money_change_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：您好，您的余额发生了变化，当前余额为：${code} 详情请登录个人中心查看。';

$_LANG['cfg_name']['pay_rem_sms_qq309485552_tpl'] = '计划任务=>订单提醒付款短信';
$_LANG['cfg_name']['pay_rem_sms_qq309485552_dayu'] = '大鱼短信模板ID';
$_LANG['cfg_desc']['pay_rem_sms_qq309485552_dayu'] = '提示:短信模板必须是在阿里大鱼“管理中心-短信模板管理”中的可用模板。示例:SMS_585014</br>阿里大鱼平台上申请模板格式：亲爱的${name}：您在本商城的购物订单：${order_sn}，还未付款，请您及时付款噢。';
...
$_LANG['cfg_name']['printer_open'] = '是否开启打印';
...
$_LANG['cfg_name']['printer_user'] = '打印机服务账户';
$_LANG['cfg_name']['printer_key'] = '打印机秘钥';
$_LANG['cfg_name']['printer_sn'] = '打印机编号';
$_LANG['cfg_name']['custom_lang'] = '页脚自定义语';
...
$_LANG['cfg_name']['use_supplier_url'] = '自定义二级域名前缀';
$_LANG['cfg_desc']['use_supplier_url'] = '设置二级域名前缀，可以使用个性二级域名快速访问店铺';

$_LANG['cfg_name']['xcx_apply'] = '申请小程序是否需要审核';
$_LANG['cfg_range']['xcx_apply']['1'] = '需要';
$_LANG['cfg_range']['xcx_apply']['0'] = '不需要';
$_LANG['cfg_desc']['xcx_apply'] = '说明：需要审核，则需要您审核通过后客户才能使用小程序后台，不需要审核的话，用户可以完全自助开通';

$_LANG['cfg_name']['jtypkey'] = '授权码';
$_LANG['cfg_desc']['jtypkey'] = '严禁修改，否则系统无法使用';


$_LANG['cfg_name']['distrib'] = '分销设置';//寒冰 qq309485552   分销设施   商家

$_LANG['cfg_name']['is_distrib'] = '是否开启分销';
...
$_LANG['cfg_desc']['distrib_type'] = '按商品分成，分成金额以商品设置的分成金额为准；按订单分成，默认所有商品都是分销商品';

$_LANG['cfg_name']['distrib_percent'] = '订单分成百分比';
$_LANG['cfg_desc']['distrib_percent'] = '选择按订单分成，此值将作为订单总额的百分比进行分成！';

$_LANG['cfg_name']['fenxiao_deposit_least_money'] = '每次佣金结算的最低金额';
$_LANG['cfg_name']['reserve_money'] = '账户需预留佣金余额';
