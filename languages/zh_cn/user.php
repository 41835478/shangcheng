...
　　１、将本站提供给您的推荐代码，发送到论坛、博客上。
　　２、访问者点击链接，访问网店。
　　３、访问者点击链接后，若该访问者在本站注册，即认定该用户是您推荐的。
　　４、该用户今后在本站的一切消费，您均能获得一定比例的提成。
　　５、提成会根据商品或者订单等信息进行计算，并非所有订单都有提成，提成一般由管理员人工审核发放，请您耐心等待。
　　６、下面仅显示已正常分成的有收益订单，如果您自己下单的订单有分成也会显示，不参与分成或者分成被撤销的不再显示。
　　７、您可以通过分成明细来查看您的介绍、分成情况。';
