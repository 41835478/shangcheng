 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: guest_stats.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
if ($_REQUEST['act'] == 'list')
{
    ...
    /* 有过订单的会员数 */
    $sql = 'SELECT COUNT(DISTINCT user_id) FROM ' .$yp->table('order_info').
    ...
    {
        $filename = yp_iconv(YP_CHARSET, 'GB2312', $_LANG['guest_statistics']);
