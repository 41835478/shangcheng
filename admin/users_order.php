...
/**
 * QQ120029121 会员排行统计程序
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: users_order.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
 ...
 */
 ...
 {
    global $db, $yp, $start_date, $end_date;
    ...
    $sql = "SELECT count(distinct(u.user_id)) FROM " .$yp->table('users')." AS u, ".$yp->table('order_info')." AS o " .$where;
    ...
    $sql = "SELECT u.user_id, u.user_name, COUNT(*) AS order_num, " .$total_fee.
               "FROM ".$yp->table('users')." AS u, ".$yp->table('order_info')." AS o " .$where .
