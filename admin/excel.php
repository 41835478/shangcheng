...
//    $sql="select o.order_sn,o.consignee,o.address,o.tel,o.add_time,o.shipping_name,o.pay_name,g.goods_name,g.goods_attr,g.goods_number,g.goods_sn,g.market_price,g.goods_price ,g.goods_number,g.goods_price*g.goods_number as money,u.user_name from  ". $GLOBALS['yp']->table('order_info').
//    " as o left join " . $GLOBALS['yp']->table('users')." as u on o.user_id=u.user_id "."left join  ". $GLOBALS['yp']->table('order_goods')." as g on o.order_id=g.order_id  $where ";
    $sql = "SELECT "
        . "o.order_sn, " // 订单号
        . "o.is_pickup, " // 订单类型
        . "o.add_time, " // 下单时间
        ...
        . " AS o LEFT JOIN " . $GLOBALS['yp']->table('users')
        . " AS u ON o.user_id = u.user_id "
        . " LEFT JOIN  " . $GLOBALS['yp']->table('order_goods')
        . " AS g ON o.order_id = g.order_id "
        . " LEFT JOIN " . $GLOBALS['yp']->table('goods')
        . " AS go ON g.goods_id = go.goods_id "
        . " LEFT JOIN " . $GLOBALS['yp']->table('brand')
        . " AS b ON go.brand_id = b.brand_id "
        . " LEFT JOIN " . $GLOBALS['yp']->table('supplier')
