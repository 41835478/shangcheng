...
/**
 * QQ120029121 超值礼包管理程序
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: package.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
if ($_REQUEST['act'] == 'add')
{
    ...
    $sql = "DELETE FROM " .$yp->table('package_goods') .
...
elseif ($_REQUEST['act'] =='update')
{
    ...
    $db->autoExecute($yp->table('goods_activity'), $record, 'UPDATE', "act_id = '" . $_POST['id'] . "' AND act_type = " . GAT_PACKAGE );
...
elseif ($_REQUEST['act'] == 'add_package_goods')
{
    ...
    foreach ($fittings AS $val)
    {
        ...
        $sql = "INSERT INTO " . $yp->table('package_goods') . " (package_id, goods_id, product_id, goods_number, admin_id) " .
...
{
    $sql = "UPDATE " . $GLOBALS['yp']->table('package_goods') . " SET " .
