...
/**
 * QQ120029121 管理中心模版相关公用函数库
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: lib_template.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
$template_files = array(
    ...
    'auction.dwt',
    'message_board.dwt',
	'takegoods',   //代码增加   By  demo.coolhong.com 今天优品 多商户系统 QQ 120-029-121
    'exchange_list.dwt',
);
...
///* 插件的 library */
//$sql = 'SELECT code, library FROM ' . $yp->table('plugins') . " WHERE assign = 1 AND library > ''";
//$res = $db->query($sql);
//
...
{
    $sql = 'SELECT code, library FROM ' . $GLOBALS['yp']->table('plugins') . " WHERE library > ''";
