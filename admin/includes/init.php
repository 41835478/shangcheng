...
define('OLD_ADMIN_PATH','admin');// add by prince 20170907 此项禁止修改
...
require(ROOT_PATH . ADMIN_PATH . '/includes/prince_lang.php');
...
if(isset($_GET['ent_id']) && isset($_GET['ent_ac']) &&  isset($_GET['ent_sign']) && isset($_GET['ent_email']))
{
    ...
    $api_comment = $t->request('http://cloud.demo.coolhong.com/api.php', $apiget);
...
if ($_REQUEST['act'] != 'login' && $_REQUEST['act'] != 'signin' &&
    $_REQUEST['act'] != 'forget_pwd' && $_REQUEST['act'] != 'reset_pwd' && $_REQUEST['act'] != 'check_order')
{
    $admin_path = preg_replace('/:\d+/', '', $yp->url()) . ADMIN_PATH;
...
$GLOBALS['smarty']->assign('qq', $db->GetOne('SELECT value  FROM ' .$yp->table('shop_config') . " WHERE  code='qq' and  parent_id=1"));
