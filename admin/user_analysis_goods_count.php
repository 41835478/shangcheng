...
/**
 * QQ120029121 会员统计-会员分析-下单商品件数
 * ============================================================================
 * 演示地址: http://demo.coolhong.com/
 * ============================================================================
 * $Author: jtypmall $
 * $Id: user_analysis_goods_count.php 2015-10-27 13:06:08Z jtypmall $
 */
...
if ($_REQUEST['act'] == 'list')
{
    ...
    // 查询
    $sql = 'SELECT u.user_name, COUNT(*) order_count FROM ' . $GLOBALS['yp']->table('users')
        . ' u LEFT JOIN ' . $GLOBALS['yp']->table('order_info')
        . ' oi ON u.user_id = oi.user_id LEFT JOIN ' . $GLOBALS['yp']->table('order_goods')
...
function get_result_list ($start_date, $end_date)
{
    ...
    if($result === false)
    {
        ...
        $sql = 'SELECT COUNT(*) FROM(SELECT * FROM ' . $GLOBALS['yp']->table('order_info') . ' oi ' . $where . ' GROUP BY user_id) t';
