...
/**
 * QQ120029121 供货商商品管理程序
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: goods.php 16345 2009-06-24 09:36:23Z PRINCE $
*/
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if ((isset($_POST['attr_id_list']) && isset($_POST['attr_value_list'])) || (empty($_POST['attr_id_list']) && empty($_POST['attr_value_list'])))
    {
        ...
        $sql = "SELECT * FROM " . $yp->table('goods_attr') . " WHERE goods_id = '$goods_id'";
...
elseif ($_REQUEST['act'] == 'drop_goods_article')
{
    ...
    $sql = "DELETE FROM " .$yp->table('goods_article') . " WHERE " . db_create_in($articles, "article_id");
    $db->query($sql);
