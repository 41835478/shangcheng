...
/**
 * QQ120029121 管理中心团购商品管理
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: group_buy.php 17217 2017-04-01 06:29:08Z PRINCE $
 */
...
elseif ($_REQUEST['act'] =='insert_update')
{
    ...
    else
    {
        ...
        {
            /* update */
            $db->autoExecute($yp->table('goods_activity'), $group_buy, 'UPDATE', "act_id = '$group_buy_id'");
        ...
        {
            /* insert */
            $db->autoExecute($yp->table('goods_activity'), $group_buy, 'INSERT');
