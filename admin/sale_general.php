 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: sale_general.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
elseif ($_REQUEST['act'] == 'download')
{
    ...
    /* 文件标题 */
    echo yp_iconv(YP_CHARSET, 'GB2312', $filename . $_LANG['sales_statistics']) . "\t\n";

    /* 订单数量, 销售出商品数量, 销售金额 */
    echo yp_iconv(YP_CHARSET, 'GB2312', $_LANG['period']) ."\t";
    echo yp_iconv(YP_CHARSET, 'GB2312', $_LANG['order_count_trend']) ."\t";
    echo yp_iconv(YP_CHARSET, 'GB2312', $_LANG['order_amount_trend']) . "\t\n";

    foreach ($data_list AS $data)
    {
        echo yp_iconv(YP_CHARSET, 'GB2312', $data['period']) . "\t";
        echo yp_iconv(YP_CHARSET, 'GB2312', $data['order_count']) . "\t";
        echo yp_iconv(YP_CHARSET, 'GB2312', $data['order_amount']) . "\t";
        echo "\n";
    }
}
