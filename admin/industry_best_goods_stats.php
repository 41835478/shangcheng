...
/**
 * QQ120029121 行业分析：行业排行：行业商品
 * ============================================================================
 * 演示地址: http://demo.coolhong.com；
 * ============================================================================
 * $Author: jtypmall $
 * $Id: industry_best_goods_stats.php 17217 2015-10-26 20:25:08Z jtypmall $
 */
...
if ($_REQUEST['act'] == 'list')
{
    ...
    // 查询分类下下单商品数
    $sql = 'SELECT og.goods_name, COUNT(*) goods_count FROM ' . $yp->table('order_info') . ' oi, '
