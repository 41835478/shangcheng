...
/**
 * QQ120029121 会员统计：新增会员
 * ============================================================================
 * 演示地址: http://demo.coolhong.com；
 * ============================================================================
 * $Author: jtypmall $
 * $Id: user_added_stats.php 17217 2015-10-27 09:43:08Z jtypmall $
 */
...
if ($_REQUEST['act'] == 'list')
{
    ...
    $user_added_today = $db->getAll(
        ...
        . $yp->table('users') . ' u ' . ' WHERE u.reg_time >=' . $start_date . ' AND u.reg_time <='
    ...
    $user_added_yesterday = $db->getAll(
        ...
        . $yp->table('users') . ' u ' . ' WHERE u.reg_time >=' . ($start_date - 86399) . ' AND u.reg_time <='
