...
/**
 * QQ120029121 店铺统计：新增店铺
 * ============================================================================
 * 演示地址: http://demo.coolhong.com；
 * ============================================================================
 * $Author: jtypmall $
 * $Id: shop_added_stats.php 17217 2015-10-29 13:15:08Z jtypmall $
 */
...
if ($_REQUEST['act'] == 'list')
{
    ...
    $shop_added_today = $db->getAll(
        "SELECT FLOOR((s.add_time - $start_date) / (24 * 3600)) add_time, COUNT(*) shop_count FROM " . $yp->table('supplier') . ' s '
    ...
    $shop_added_yesterday = $db->getAll(
        "SELECT FLOOR((s.add_time + 86400 - $start_date) / (24 * 3600)) add_time, COUNT(*) shop_count FROM " . $yp->table('supplier') . ' s '
