...
$exc = new exchange($yp->table("supplier_tag"), $db, 'tag_id', 'tag_name');
...
if ($_REQUEST['act'] == 'list')
{
    ...
    $tags = array();
    $tags = $db->getAll("SELECT * FROM " .$yp->table('supplier_tag')." order by sort_order ");
...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO " .$yp->table('supplier_tag') ."( ".
