...
/**
 * QQ120029121 会员统计-会员分析-下单量
 * ============================================================================
 * 演示地址: http://demo.coolhong.com/
 * ============================================================================
 * $Author: jtypmall $
 * $Id: user_analysis_order_count.php 2015-10-27 13:06:08Z jtypmall $
 */
...
if ($_REQUEST['act'] == 'list')
{
    ...
    $sql = 'SELECT u.user_name, COUNT(*) order_count FROM ' . $GLOBALS['yp']->table('users')
        . ' u LEFT JOIN ' . $GLOBALS['yp']->table('order_info') . ' oi ON u.user_id = oi.user_id ' . $where
