 ...
 * ==========================================================
 * $Author: jtypmall $
 * $Id: flashplay.php 16131 2009-05-31 08:21:41Z jtypmall $
 */
...
elseif ($_REQUEST['act']== 'download')
{
    ...
    /* 文件下载 */
    yp_header("Content-Type:text/plain");
    yp_header("Accept-Ranges:bytes");
    yp_header("Content-Disposition: attachment; filename=CERTIFICATE.CER");
...
elseif ($_REQUEST['act']== 'upload')
{
    ...
    else
    {
        ...
        $sql = "UPDATE " . $yp->table('shop_config') . "
