<?php
/**
 * QQ120029121 售后统计：返修统计
 * ============================================================================
 * 演示地址: http://demo.coolhong.com/
 * ============================================================================
 * $Author: jtypmall $
 * $Id: repair_stats.php 2015-10-25 16:44:08Z jtypmall $
 */
...
if ($_REQUEST['act'] == 'list')
{
    ...
    $sql = "SELECT FLOOR((b.add_time - $start_date) / (24 * 3600)) date, count(*) repair_count FROM "
        . $yp->table('back_order') . ' b ' . $where . ' AND b.back_type = 3 GROUP BY date ORDER BY date';
    // 返修件数统计
...
function get_result_list($start_date, $end_date, $sel_shop, $supplier_id)
{
    ...
    if($result === false)
    {
        ...
        $sql = "SELECT COUNT(*) FROM " . $GLOBALS['yp']->table('back_order') . ' b ' . $where . ' AND b.back_type = 3';
