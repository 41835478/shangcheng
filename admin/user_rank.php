 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: user_rank.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
$exc_user = new exchange($yp->table("users"), $db, 'user_rank', 'user_rank');
...
{
    $ranks = array();
    $ranks = $db->getAll("SELECT * FROM " .$yp->table('user_rank'));
...
elseif ($_REQUEST['act'] == 'insert')
{
	...
	$sql = "INSERT INTO " .$yp->table('user_rank') ."( ".
...
elseif ($_REQUEST['act'] == 'edit_min_points')
{
    ...
    $rank = $db->getRow("SELECT max_points, special_rank FROM " . $yp->table('user_rank') . " WHERE rank_id = '$rank_id'");
...
elseif ($_REQUEST['act'] == 'edit_max_points')
{
    ...
    $rank = $db->getRow("SELECT min_points, special_rank FROM " . $yp->table('user_rank') . " WHERE rank_id = '$rank_id'");
