 ...
 * $Id: help.php 17069 2010-03-26 05:28:01Z demo.coolhong.com 今-天-优-品-多-商-户-系-统 Q-Q：12 00 29 12 1 $
*/
...
elseif ($article_id == 0)
{
	$sql = 'SELECT a.article_id ' .
            'FROM ' .$GLOBALS['yp']->table('article'). ' AS a, '  .$GLOBALS['yp']->table('article_cat'). ' AS c ' .
...
function get_cat_id_art($article_id){
	$sql = "select cat_id from " .$GLOBALS['yp']->table('article'). " where article_id = '$article_id'";
