 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: jiekou.php 17217 2017-04-01 06:29:08Z PRINCE $

详述: 参见概述 PS: 强烈建议修改默认接口密码!!!
使用: 将本文件放在网站根目录下, 存放路径示例: D:\Htdoc\JTYPmall_V2.7.3_UTF8_release1106\jiekou.php
...
分类下拉菜单获取地址示例: http://demo.coolhong.com/jiekou.php?cattree=true
*/
...
/*检查是否重复*/
$is_exist = $db->getone("select * from ". $yp->table('article') ." where title ='". $_POST['title'] ."' and cat_id = '". $_POST['article_cat'] ."'");
if ($is_exist)
{
