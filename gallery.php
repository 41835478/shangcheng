 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: gallery.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
/* 获得商品名称 */
$sql = 'SELECT goods_name FROM ' . $yp->table('goods') . "WHERE goods_id = '$_REQUEST[id]'";
...
{
    /* 如果没有图片，返回商品详情页 */
    yp_header('Location: goods.php?id=' . $_REQUEST['id'] . "\n");
    exit;
}
else
{
