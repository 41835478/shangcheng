...
if(isset($postcom)&&isset($getNu)){
	...
	$powered = '查询服务由：<a href="https://www.kuaidi100.com" target="_blank" style="color:blue">快递100</a> 网站提供';
	...
	//修复https下无法获取查询结果的问题 start  20170914 prince q q 1 2 0 0 2 9 1 2 1
	include("../../data/config.php");
	if(HTTP_TYPE=='https'){
		$get_content=str_replace("http://","https://",$get_content);
	}
	//修复https下无法获取查询结果的问题 end  20170914 prince q q 1 2 0 0 2 9 1 2 1
