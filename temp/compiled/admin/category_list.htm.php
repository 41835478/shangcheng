<!-- $Id: category_list.htm 17019 2010-01-29 10:10:34Z Prince $ -->
...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    <td align="left" class="first-cell" >
      ...
      <a href="goods.php?act=list&cat_id=<?php echo $this->_var['cat']['cat_id']; ?>&supp=-1"><?php echo $this->_var['cat']['cat_name']; ?></a>
      <?php elseif ($this->_var['cat']['is_result'] == 1): ?>
      <a href="goods.php?act=list&cat_id=<?php echo $this->_var['cat']['cat_id']; ?>&supp=-1" style="font-size: 14px;"><?php echo $this->_var['cat']['cat_name']; ?></a>
      <?php else: ?>
      <a href="goods.php?act=list&cat_id=<?php echo $this->_var['cat']['cat_id']; ?>&supp=-1" style="color: #CDCDCD;"><?php echo $this->_var['cat']['cat_name']; ?></a>
      <?php endif; ?>
      </span>
    ...
    <td width="10%"><img src="images/<?php if ($this->_var['cat']['is_xcx_show'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_is_xcx_show', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>
