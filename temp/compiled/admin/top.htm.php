...
#submenu-div li {
float: right;
 width:77px;  text-align:center; height:68px; 
...
#menu-div li.midd_21 {
	background:url(images/midd.png) no-repeat;background-position:10px 13px; border-left:4px #00A65A solid; text-indent:12px;
...
#tabbar-div {
  /*background:#0e94d1;*/
  background:#00A65A;  font-family:"微软雅黑";
...
<div id="header-div" style="display:block;">
    <div id="logo-div"><img src="images/jtyp_logo.png" alt="今天优品" title="今 天 优 品 多 商 户 系 统" /></div>
...
<li class="show_8"><a href="http://demo.coolhong.com/" target="_blank"><?php echo $this->_var['lang']['help']; ?></a></li>
<!--li class="show_7"><a href="http://wifi.coolhong.com/"  target="_blank">wifi智慧云</a></li-->
...
<li class="show_4"><a href="../mobile/<?php echo $this->_var['admin_path']; ?>/index.php?act=clear_cache"    target="main_frame">手机缓存</a></li>
<li class="show_4"><a onclick="clear_cache()"  target="main_frame"><?php echo $this->_var['lang']['clear_cache']; ?></a></li>
<li class="show_4"><a onclick="clear_html()"   target="main_frame">更新全部</a></li>
<li class="show_4"><a onclick="clear_index()"  target="main_frame">更新首页</a></li>
<li class="show_11"><a href="../mobile/" target="_blank">手机前台</a></li>
<li class="show_1"><a href="../" target="_blank">PC前台</a></li></ul>
   <?php if ($this->_var['send_mail_on'] == 'on'): ?>
