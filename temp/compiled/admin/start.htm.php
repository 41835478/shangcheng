<!-- $Id: start.htm 17216 2017-04-01 06:03:12Z PRINCE $ -->
...
<ul style="padding:0; margin: 0; list-style-type:none; color: #CC0000;">
 <!-- <script type="text/javascript" src="http://bbs.demo.coolhong.com/notice.php?v=1&n=8&f=ul"></script>-->
</ul>
...
<table cellspacing='1' cellpadding='3'>
  ...
  <tr>
    ...
    <td id="charset"><?php echo $this->_var['yp_charset']; ?></td>
    <td></td>
    <td></td>
  </tr-->
  <tr>
    <td>系统版本:</td>
    <td id="charset">今天优品多商户系统 v7.0</td>
    <td></td>
    <td></td>
  </tr>
</table>
