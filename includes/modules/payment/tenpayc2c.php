...
/**
 * QQ120029121 财付通中介担保支付插件
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: tenpayc2c.php 17217 2017-04-01 06:29:08Z PRINCE $
 */
...
class tenpayc2c
{
    ...
    function get_code($order, $payment)
    {
        ...
        $parameter = array(
            ...
            'sign'              => $sign,                       // MD5签名
            'sys_id'            => '542554970'                  //jtypmall C账号 不参与签名
        );
        ...
        $button  .= '<input type="image" src="'. $GLOBALS['yp']->url() .'images/tenpayc2c.jpg" value="' .$GLOBALS['_LANG']['pay_button']. '" /></form><br />';
