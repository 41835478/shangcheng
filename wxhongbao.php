 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: wxhongbao.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
public	function arrayToXml($arr)
	...
	{		
	 ...
	 public function wxHttpsRequestPem( $vars,$url, $second=30,$aHeader=array()){
                ...
                curl_setopt($ch,CURLOPT_SSLCERT,dirname(__FILE__).'/prince/cert/apiclient_cert.pem');
                //默认格式为PEM，可以注释
                curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
                curl_setopt($ch,CURLOPT_SSLKEY,dirname(__FILE__).'/prince/cert/apiclient_key.pem');
 
                curl_setopt($ch,CURLOPT_CAINFO,'PEM');
                curl_setopt($ch,CURLOPT_CAINFO,dirname(__FILE__).'/prince/cert/rootca.pem');
