...
/**
 * QQ120029121 RSS Feed 生成程序
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: feed.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
$rss = new RSSBuilder(YP_CHARSET, $uri, htmlspecialchars($_CFG['shop_name']), htmlspecialchars($_CFG['shop_desc']), $uri . 'animated_favicon.gif');
$rss->addDCdata('', 'http://demo.coolhong.com', date('r'));
...
else
{
    ...
    $sql = 'SELECT c.cat_name, g.goods_id, g.goods_name, g.goods_brief, g.last_update ' .
            'FROM ' . $yp->table('category') . ' AS c, ' . $yp->table('goods') . ' AS g ' .
