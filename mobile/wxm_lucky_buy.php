...
if($lucky_buy_id && $ret_re['lucky_buy_lucky_user_notice']==1){
	...
	$sql = "SELECT * FROM  " . $GLOBALS['yp']->table('lucky_buy') . " l ".
							"left join  " . $GLOBALS['yp']->table('goods_activity') . "  g on l.act_id=g.act_id ".
	...
	$sql= "SELECT * FROM " . $GLOBALS['yp']->table('users') . " WHERE user_id = '$lucky_user_id'";
