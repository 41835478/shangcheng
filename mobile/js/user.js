...
/*******************************************************************************
 * 会员余额申请  20161126 mod by p r i n c e  q q 120 029 121
 */
...
function changeType(obj) {
	if (obj.getAttribute("min") && document.getElementById("YP_AMOUNT")) {
		document.getElementById("YP_AMOUNT").disabled = false;
		document.getElementById("YP_AMOUNT").value = obj.getAttribute("min");
		if (document.getElementById("YP_NOTICE") && obj.getAttribute("to") && obj.getAttribute('fee')) {
			var fee = parseInt(obj.getAttribute("fee"));
			var to = parseInt(obj.getAttribute("to"));
			if (fee < 0) {
				to = to + fee * 2;
			}
			document.getElementById("YP_NOTICE").innerHTML = notice_result + to;
		}
	}
}

function calResult() {
	var amount = document.getElementById("YP_AMOUNT").value;
	var notice = document.getElementById("YP_NOTICE");
