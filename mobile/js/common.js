  ...
  if (result.error > 0)
  {
    ...
    else if (result.error == 999 )
    {
      ...
      alert(result.message);
        ...
        var cartInfo = document.getElementById('YP_CARTINFO');
	var cartInfo1 = document.getElementById('YP_CARTINFO1');
...

  {
...

      {
...

        {
...

          {
            ...
            newDiv.innerHTML += "<div style='line-height:40px; font-size: 14px; float:left; '><input style='margin-left:15px;' type='radio' name='spec_" + message[spec]['attr_id'] + "' value='" + message[spec]['values'][val_arr]['id'] + "' id='spec_value_" + message[spec]['values'][val_arr]['id'] + "' checked /> <font color=#555555>" + message[spec]['values'][val_arr]['label'] + '</font> </font><br /></div>';
...

          {
            ...
            newDiv.innerHTML += "<div style='line-height:40px;font-size: 14px; float:left; '><input style='margin-left:15px;' type='radio' name='spec_" + message[spec]['attr_id'] + "' value='" + message[spec]['values'][val_arr]['id'] + "' id='spec_value_" + message[spec]['values'][val_arr]['id'] + "' /> <font color=#555555>" + message[spec]['values'][val_arr]['label'] + '</font></font><br /></div>';
...

      {
...

        {
          ...
          newDiv.innerHTML += "<div style='line-height:40px;font-size: 14px;'><input style='margin-left:15px;' type='checkbox' name='spec_" + message[spec]['attr_id'] + "' value='" + message[spec]['values'][val_arr]['id'] + "' id='spec_value_" + message[spec]['values'][val_arr]['id'] + "' /><font color=#555555>" + message[spec]['values'][val_arr]['label'] + '</font><br /></div>';
