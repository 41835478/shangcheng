...
function get_pro_search_list($limit){
    ...
    while ($row = $GLOBALS['db']->FetchRow($res))
    {
        ...
        $arr[$row['goods_id']]['goods_thumb']   = get_image_path($row['goods_id'], $row['goods_thumb'], true);//mod by qq120-029-121 20160815
        $arr[$row['goods_id']]['goods_img']     = get_image_path($row['goods_id'], $row['goods_img']);//mod by qq120-029-121 20160815
