 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: cls_template.php 17217 2017-04-01 06:29:08Z PRINCE $
 */
...
class cls_template
{
    ...
    function fetch($filename, $cache_id = '')
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ($cache_id)
                    {
                        ...
                        if (file_put_contents($hash_dir . '/' . $cachename . '.html', '<?php exit;?>' . $data . $out, LOCK_EX) === false)
                        {
		...
		if(HTTP_TYPE=='https'){
			...
			$out=str_replace("src='http://","src='https://",$out);
			$out=str_replace("url(http:","url(https:",$out);
		}//20170618
        return $out; // 返回html数据
    }
