...
/**
 * QQ120029121 SQL语句执行类。在调用该类方法之前，请参看相应方法的说明。
 *
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: prince $
 * $Id: cls_sql_executor.php 17217 2017-04-01 06:29:08Z prince $
 */
...
class sql_executor
{
     ...
     * @return  void
     */
    function __construct($db, $charset = 'gbk', $sprefix = 'yp_', $tprefix = 'yp_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
     ...
     * @return  void
     */
    function sql_executor($db, $charset = 'gbk', $sprefix = 'yp_', $tprefix = 'yp_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
        $this->db = $db;
