...
class weixin {
	...
	function get_code($order, $payment) {
        ...
        $this->logResult("log::get_code::unifiedOrder:".$unifiedOrder);  // PRINCE 
	...
	function respond() {
        ...
        $this->logResult("mlog::respond::xml:".$xml);  // PRINCE 
		$notify->saveData ( $xml );
		$payment = get_payment ( 'weixin' );
		define ( KEY, $payment ['partnerKey'] ); // 通加密串
		
		
		//if (1) {//若因支付参数来自不同商户，可暂时绕过下面验证测试，add by prince
