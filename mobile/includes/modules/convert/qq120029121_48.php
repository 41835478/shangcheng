...
/**
 * qq1200291214.8转换程序插件
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: prince $
 * $Id: qq120029121_48.php 17217 2017-04-01 06:29:08Z prince $
 */
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 描述对应的语言项 */
    $modules[$i]['desc'] = 'qq120029121_48_desc';
...
class qq120029121_48
{
    ...
    /* 构造函数 */
    function qq120029121_48(&$sdb, $sprefix, $sroot, $scharset = 'UTF8')
    {
        $this->sdb = $sdb;
    ...
    function process_brand()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $brand = array(
                ...
                'brand_desc' => '',
                'site_url' => yp_iconv($this->scharset, $this->tcharset, addslashes($row['brand_url'])),
    ...
    function process_users()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $user['user_name']      = yp_iconv($this->scharset, $this->tcharset, addslashes($row['uname']));
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $address['address']         = yp_iconv($this->scharset, $this->tcharset, addslashes($row['addr']));
    ...
    function process_article()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $article['content']     = yp_iconv($this->scharset, $this->tcharset, addslashes($row['content']));
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $link['link_name']   = yp_iconv($this->scharset, $this->tcharset, addslashes($row['link_name']));
    ...
    function process_order()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $order['consignee']         = yp_iconv($this->scharset, $this->tcharset, addslashes($row['consignee']));
            $order['address']           = yp_iconv($this->scharset, $this->tcharset, addslashes($row['ship_addr']));
            ...
            $order['shipping_name']     = yp_iconv($this->scharset, $this->tcharset, addslashes($row['ship_name']));
            $order['pay_name']          = yp_iconv($this->scharset, $this->tcharset, addslashes($row['shipping']));
            $order['inv_payee']         = yp_iconv($this->scharset, $this->tcharset, addslashes($row['tax_company']));
    ...
    function process_config()
    {
        ...
        $config = array();
        //$config['shop_name']        = yp_iconv($this->scharset, $this->tcharset, addslashes($store_arr[0]);
        //$config['shop_title']       = yp_iconv($this->scharset, $this->tcharset, addslashes($store_arr[0]));
        //$config['shop_desc']        = yp_iconv($this->scharset, $this->tcharset, addslashes($store_arr[1]));
        //$config['shop_address']     = yp_iconv($this->scharset, $this->tcharset, addslashes($row['store']));
