...
function extpintuan_count($supplier_id)

{
    ...
    $sql = "SELECT COUNT(*) " .
            ...
            "WHERE supplier_id = '$supplier_id' AND act_type = '" . GAT_EXTPINTUAN . "' " .
			$where.
            " ";
...
function extpintuan_list($size, $page ,$supplier_id)
...
{   
    ...
    $sql = "SELECT b.*, IFNULL(g.goods_thumb, '') AS goods_thumb, g.*,b.act_id AS extpintuan_id, ".
            ...
            "WHERE b.supplier_id = '$supplier_id' AND b.act_type = '" . GAT_EXTPINTUAN . "' " .
			$where.
...
function get_extpintuan_detail($supplier_id)
