 ...
 * ==========================================================
 * $Author: prince $
 * $Id: cls_json.php 17217 2017-04-01 06:29:08Z prince $
 */
...
class JSON
{
    ...
    function encode($arg, $force = true)
    {
        ...
        if ($_force && YP_CHARSET == 'utf-8' && function_exists('json_encode'))
        {
    ...
    function decode($text,$type=0) // 榛樿?type=0杩斿洖obj,type=1杩斿洖array
    {
        ...
        if (YP_CHARSET === 'utf-8' && function_exists('json_decode'))
        {
