 ...
 * ============================================================================
 * 版权所有 2005-2010 广州热风科技有限公司二次开发，并保留所有权利。
 * 演示地址: http://www.sojieke.cn  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: Prince $
 * $Id: lib_transaction.php 17063 2010-03-25 06:35:46Z Prince $
*/
...
function get_user_orders_1($user_id, $num = 10, $start = 0,$where='')
{
	...
	$row['order_status1'] = $row['order_status'];
		...
		$arr[$row['order_id']] = array('order_id'       => $row['order_id'],
						...
						'is_suborder' => $row['parent_order_id'] ? "(子订单)" : "",  //代码增加   By  qq-120029121
