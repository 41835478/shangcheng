...
{
	$sql = "update " . $GLOBALS['yp']->table('chat_customer') . " set cus_status = '$cus_status' where cus_id = '$cus_id'";
...
//		$cus_type = CUSTOMER_SERVICE;
	...
	$sql = "select * from " . $GLOBALS['yp']->table('chat_customer') . " WHERE cus_enable = 1 AND cus_type in ($cus_type) $where ORDER BY cus_type desc";
