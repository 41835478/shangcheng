...
/**
 * QQ120029121 LICENSE 相关函数库
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: prince $
 * $Id: lib_article.php 16336 2009-06-24 07:09:13Z prince $
*/
 ...
 * @return  string
 */
function make_qq120029121_ac($post_params, $token)
{
 ...
 * @param   bool      $use_lib  使用哪一个json库，0为ec，1为qq120029121
 * @return  array
 */
function exchange_shop_license($certi, $license, $use_lib = 0)
{
    ...
    {
        include_once(ROOT_PATH . 'includes/wx120029121_json.php');
...
function license_login($certi_added = '')
{
    ...
    $certi['certi_url'] = sprintf($GLOBALS['yp']->url()); // 网店URL
    $certi['certi_session'] = $GLOBALS['sess']->get_session_id(); // 网店SESSION标识
    $certi['certi_validate_url'] = sprintf($GLOBALS['yp']->url() . 'certi.php'); // 网店提供于官方反查接口
...
function license_reg($certi_added = '')
{
    ...
    $certi['certi_ac'] = make_qq120029121_ac($certi, ''); // 网店验证字符串
    ...
    {
        // 注册信息入库
        $sql = "UPDATE " . $GLOBALS['yp']->table('ypmart_shop_config',1) . "
