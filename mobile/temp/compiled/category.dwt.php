...
<link rel="stylesheet" type="text/css" href="themesmobile/prince_jtypmall_mobile/css/category.css"/>
<script type="text/javascript" src="themesmobile/prince_jtypmall_mobile/js/jquery.js"></script>
<?php echo $this->smarty_insert_scripts(array('files'=>'jquery.json.js,transport.js')); ?>
<?php echo $this->smarty_insert_scripts(array('files'=>'common.js')); ?>
<script type="application/javascript" src="themesmobile/prince_jtypmall_mobile/js/jquery.more.js"></script>
</head>
<body class="body_bj">
<?php 
$k = array (
...
<li class="<?php if ($this->_var['pager']['sort'] == 'goods_id'): ?>on<?php endif; ?>"><a href="<?php echo $this->_var['script_name']; ?>.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=goods_id&order=<?php if ($this->_var['pager']['sort'] == 'goods_id' && $this->_var['pager']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#goods_list">最新</a></li>

<li class="<?php if ($this->_var['pager']['sort'] == 'salenum'): ?>on<?php endif; ?>"><a href="<?php echo $this->_var['script_name']; ?>.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=salenum&order=<?php if ($this->_var['pager']['sort'] == 'salenum' && $this->_var['pager']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#goods_list" >销量</a></li>

<li class="<?php if ($this->_var['pager']['sort'] == 'last_update'): ?>on<?php endif; ?>"><a href="<?php echo $this->_var['script_name']; ?>.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=last_update&order=<?php if ($this->_var['pager']['sort'] == 'last_update' && $this->_var['pager']['order'] == 'DESC'): ?>ASC<?php else: ?>DESC<?php endif; ?>#goods_list" >更新</a></li>

<li class="<?php if ($this->_var['pager']['sort'] == 'final_price'): ?>on<?php endif; ?>" ><a href="<?php echo $this->_var['script_name']; ?>.php?category=<?php echo $this->_var['category']; ?>&display=<?php echo $this->_var['pager']['display']; ?>&brand=<?php echo $this->_var['brand_id']; ?>&price_min=<?php echo $this->_var['price_min']; ?>&price_max=<?php echo $this->_var['price_max']; ?>&filter_attr=<?php echo $this->_var['filter_attr']; ?>&page=<?php echo $this->_var['pager']['page']; ?>&sort=final_price&order=<?php if ($this->_var['pager']['sort'] == 'final_price' && $this->_var['pager']['order'] == 'ASC'): ?>DESC<?php else: ?>ASC<?php endif; ?>#goods_list">价格<span class="arrow_up <?php if ($this->_var['pager']['sort'] == 'final_price' && $this->_var['pager']['order'] == 'ASC'): ?>active_up<?php endif; ?>"></span><span class="arrow_down <?php if ($this->_var['pager']['sort'] == 'final_price' && $this->_var['pager']['order'] == 'DESC'): ?>active_down<?php endif; ?>"></span></a></li>

<li style=" border-left:1px solid #ccc; margin-right:-1px;"><a href="javascript:;" class="show_type <?php if ($this->_var['pager']['display'] == 'grid'): ?> show_list<?php endif; ?>">&nbsp;</a></li>
</ul>
</section>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
     ...
     <form method="post" action="category.php?u=<?php echo $this->_var['user_id']; ?>">
...
<?php $_from = $this->_var['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brand_0_75857700_1510283504');if (count($_from)):
    foreach ($_from AS $this->_var['brand_0_75857700_1510283504']):
?>
<li <?php if ($this->_var['brand_0_75857700_1510283504']['selected']): ?>class="on"<?php endif; ?>  id="brand_<?php echo $this->_var['brand_0_75857700_1510283504']['brand_id']; ?>"><a href="javascript:get_brand('<?php echo $this->_var['brand_0_75857700_1510283504']['brand_id']; ?>')"><?php echo $this->_var['brand_0_75857700_1510283504']['brand_name']; ?></a></li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        ...
        <div class="filtrate_price"onclick="return 1;">
                 ...
                 <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_75857700_1510283504');$this->_foreach['filter_attr_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['filter_attr_list']['total'] > 0):
    foreach ($_from AS $this->_var['filter_attr_0_75857700_1510283504']):
        $this->_foreach['filter_attr_list']['iteration']++;
?>  
        <div class="filtrate_category" >
            <a href="javascript:;" class="filtrate_category_a"><?php echo htmlspecialchars($this->_var['filter_attr_0_75857700_1510283504']['filter_attr_name']); ?><?php echo $this->_var['lang']['colon']; ?> <span class="up_down">全部</span></a>
        </div>
        <ul class="clearfix filtrate_address filtrate_list att_item" id="attrs_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>">
        <?php $_from = $this->_var['filter_attr_0_75857700_1510283504']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');$this->_foreach['filter_attr'] = array('total' => count($_from), 'iteration' => 0);
...
<input type="hidden" id="showqq120029121_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>" name="showqq120029121" value="<?php echo $this->_var['attr']['attr_id']; ?>"/>
<?php endif; ?>
        </li>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
...
<script type="text/javascript" src="themesmobile/prince_jtypmall_mobile/js/zepto.min.js"></script>
<script type="text/javascript" src="themesmobile/prince_jtypmall_mobile/js/filter.min.js"></script>
<script>
...
{
	document.getElementById('showqq120029121_<?php echo $this->_foreach['filter_attr_list']['iteration']; ?>').value=attr_id;
	var showqq120029121 = document.getElementsByName("showqq120029121");
	var zongshu = null;
	for(var i=showqq120029121.length;i>0;i--){
	if(zongshu == null)
	{
		zongshu = document.getElementById("showqq120029121_"+i).value;
	
	}
	else
	{
		zongshu = document.getElementById("showqq120029121_"+i).value +"."+zongshu;
...
<a href="javascript:goTop();" class="gotop" style=" z-index:9999"><img src="themesmobile/prince_jtypmall_mobile/images/topup.png"></a> 
</body>
</html>