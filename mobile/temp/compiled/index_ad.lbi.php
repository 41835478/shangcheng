<style>
	.scrollimg{position:relative; overflow:hidden; margin:0px auto; margin-top:45px; /* 设置焦点图最大宽度 */}
...
box-shadow: 0 0 2px #ccc; }
	...
	.scrollimg .bd li img{background:url(themesmobile/prince_jtypmall_mobile/images/loading.gif) center center no-repeat;  vertical-align:top; width:100%;/* 图片宽度100%，达到自适应效果 */}
	.scrollimg .bd li a{-webkit-tap-highlight-color:rgba(0,0,0,0);}  /* 去掉链接触摸高亮 */
	.scrollimg .bd li .tit{display:block; width:100%;  position:absolute; bottom:0; text-indent:10px; height:28px; line-height:28px; background:url(themesmobile/prince_jtypmall_mobile/images/focusBg.png) repeat-x; color:#fff;  text-align:left;}
</style>
