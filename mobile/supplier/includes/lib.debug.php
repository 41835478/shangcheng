    ...
    ************************************************/
    ...
    function print_a( $array, $mode = 0, $show_object_vars = false, $limit = false ) {
        ...
        if( is_array( $array ) or is_object( $array ) ) {
            ...
            $pa = new Print_a_class;   //´úÂëÐÞ¸Ä  By  demo.coolhong.com ä»Šå¤©ä¼˜å“ å¤šå•†æˆ·ç³»ç»?QQ 120-029-121
        ...
        if(is_string($mode) || $mode == 2 ) {
            ...
            if(preg_match('/^_(.*)/', $mode, $matches)) {
                ...
                debugwindow.document.title = "'.(is_string($mode) ? "($mode)" : '').' Debugwindow for : '.HTTP_TYPE.'://'.$debugwindow_origin.'";
                debugwindow.focus();
                </script>
                ';
            }
        ...
        if($mode == 3) {
            print '
                <script type="text/javascript" language="JavaScript">
                    ...
                    debugwindow.document.close();
                    debugwindow.document.title = "Debugwindow for : '.HTTP_TYPE.'://'.$debugwindow_origin.'";
                    debugwindow.focus();
                </script>
            ';
        }
