...
/**
 * QQ120029121 MYSQL 公用类库
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:120029121    309485552
 * ============================================================================
 * $Author: PRINCE $
 * $Id: cls_mysql.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
class cls_mysql
{
    ...
    public $max_cache_time = 0; // 最大的缓存时间，以秒为单位  20170905 prince 
    ...
    function __construct($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'gbk', $pconnect = 0, $quiet = 0)
    {
        ...
        {
            $charset = strtolower(str_replace('-', '', YP_CHARSET));
        }
    ...
    {
       $info = explode(':', $dbhost);
       $this->link_id = @mysqli_connect($info[0], $dbuser, $dbpw, $dbname,$info[1]);
        ...
        if ($dbname)
        {
            if (!$this->select_database($dbname))
            {
                if (!$quiet)
                {
    ...
    function ErrorMsg($message = '', $sql = '')
    {
        if ($message)
        {
            echo "<b>QQ120029121 info</b>: $message\n\n<br /><br />";
        ...
        {
            echo "<pre>MySQL server error report:";
