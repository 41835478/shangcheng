...
{
	$sql = "select sum(goods_number) from " . $GLOBALS['yp']->table('order_goods') . " AS g ,".$GLOBALS['yp']->table('order_info') . " AS o WHERE o.order_status >1 and o.order_id=g.order_id and g.goods_id = " . $goods_id    ;/*注意订单状态*/
