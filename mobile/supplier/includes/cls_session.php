 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: cls_session.php 17217 2017-04-01 06:29:08Z PRINCE $
*/
...
class cls_session
{
    ...
    function __construct(&$db, $session_table, $session_data_table, $session_name = 'YP_ID', $session_id = '')
    {
        $this->cls_session($db, $session_table, $session_data_table, $session_name, $session_id);
    }

    function cls_session(&$db, $session_table, $session_data_table, $session_name = 'YP_ID', $session_id = '')
    {
        ...
        else
        {
            ...
            setcookie($this->session_name, $this->session_id . $this->gen_session_key($this->session_id), time()+86400*7, $this->session_cookie_path, $this->session_cookie_domain, $this->session_cookie_secure); //代码修改 By  demo.coolhong.com 今天优品 多商户系统 QQ 120-029-121  
        }
