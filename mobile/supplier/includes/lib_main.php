 ...
 */
 ...
 //		toolbars:[[\'source\', \'|\',\'Undo\',\'|\', \'Redo\',\'|\',\'simpleupload\',\'|\',\'insertimage\',\'|\',\'justifyleft\',\'|\', \'justifycenter\',\'|\', \'justifyright\',\'|\', \'justifyjustify\',\'|\',\'forecolor\',\'|\',\'fontfamily\',\'|\', \'fontsize\']], 	autoFloatEnabled:false, 
function create_html_editor($input_name, $input_value = '')
{
    ...
    <textarea name="'.$input_name.'" id="'.$input_name.'" style="width:80%;overflow: hidden;">'.$input_value.'</textarea>
    <script type="text/javascript">
    UE.getEditor("'.$input_name.'",{
     toolbars:[[\'Undo\',\'|\', \'Redo\',\'|\',\'simpleupload\',\'|\',\'insertimage\',\'|\',\'justifyleft\',\'|\', \'justifycenter\',\'|\', \'justifyright\',\'|\', \'justifyjustify\',\'|\',\'forecolor\',\'|\', \'fontsize\']],  
    theme:"default", //皮肤
    lang:"zh-cn",    //语言
	elementPathEnabled : false,
    autoFloatEnabled:false, 
    initialFrameWidth:null,  //初始化编辑器宽度,默认650
