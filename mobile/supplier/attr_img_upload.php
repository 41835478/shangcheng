...
require_once(PC_ROOT_PATH . '/' . ADMIN_PATH . '/includes/lib_goods.php');
...
elseif ($_REQUEST['act'] == 'set_attrimage')
{
	...
	$sql_qq_wx_120029121 = "update ". $GLOBALS['yp']->table('goods_gallery') ." set is_attr_image='0' where goods_id='$goods_id' and goods_attr_id='$goods_attr_id' ";
	$db->query($sql_qq_wx_120029121);
	$sql_qq_wx_120029121 = "update ". $GLOBALS['yp']->table('goods_gallery') ." set is_attr_image='1' where img_id='$img_id_qq_wx_120029121' ";
	$db->query($sql_qq_wx_120029121);
	clear_cache_files();
}
...
elseif($_REQUEST['act'] == 'set_sort_img')
{
	...
	$sql = "update ". $GLOBALS['yp']->table('goods_gallery') ." set img_sort=".$sort." where img_id=".$_POST['img_id'];
	$db->query($sql);
}
?>
...
$img_list =array();
$sql = "SELECT * FROM " . $yp->table('goods_gallery') . " WHERE goods_attr_id= '$goods_attr_id' and goods_id = '$goods_id' order by img_sort,img_id ";
    ...
    $proc_thumb = (isset($GLOBALS['shop_id']) && $GLOBALS['shop_id'] > 0)? false : true;
        ...
        if ($flag)
        {
           ...
           $img_url = $GLOBALS['image']->make_thumb($img_original , $GLOBALS['_CFG']['image_width'],  $GLOBALS['_CFG']['image_height']);
            ...
            $sql = "INSERT INTO " . $GLOBALS['yp']->table('goods_gallery') . " (goods_id, img_url, img_desc, thumb_url, img_original, goods_attr_id) " .
