...
$_LANG['new_register'] = '免费注册';//寒冰  qq   309485552    20161117
...
$_LANG['next_level'] = '您还差 %s 成长值达到 %s ';
$_LANG['attention'] = '关注';
...
　<span>３</span>、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在本站注册，即认定该用户是您推荐的，您将获得成长值 <b>%d</b> 的奖励 (当您的成长值超过 <b>%d</b> 时，不再获得奖励)。
...
$_LANG['affiliate_intro'][0] = '　　本网店为鼓励推荐新用户注册，现开展<b>推荐注册分成</b>活动，活动流程如下：
　<span>１</span>、将本站商品或者首页分享到您的微信、QQ、博客上。
　<span>２</span>、访问者点击链接，访问网店。
　<span>３</span>、访问者点击链接并在本站注册，即认定该用户是您推荐的。
　<span>４</span>、该用户今后在本站的一切消费，您均能获得一定比例的提成。具体分配规则请参阅下方。
　<span>５</span>、提成会根据商品或者订单等信息进行计算，并非所有订单都有提成，提成一般由管理员人工审核发放，请您耐心等待。
　<span>６</span>、您可以通过分销中心来查看您的介绍、分成情况。';
...
$_LANG['affiliate_intro'][2] = '
    　<span>１</span>、这里仅显示已正常分成的有收益订单，如果您自己下单的订单有分成也会显示，不参与分成或者分成被撤销的不再显示。
    　<span>２</span>、分成佣金会根据商品或者订单等信息进行计算，并非所有订单均有分佣。
    　<span>３</span>、您可以通过佣金流水来查看您的详细分成情况';
...
$_LANG['level_point'] = '成长值分成比';
$_LANG['level_money'] = '现金分成比';

$_LANG['affiliate_status'] = '分成状态';

$_LANG['affiliate_point'] = '成长值奖励';
