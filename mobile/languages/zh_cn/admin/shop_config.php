...
$_LANG['cfg_name']['order_draw'] = '是否开启订单抽奖功能';
$_LANG['cfg_range']['order_draw'][1] = '开启';
$_LANG['cfg_range']['order_draw'][0] = '关闭';
$_LANG['cfg_desc']['order_draw'] = '订单抽奖功能指的是当客户订单付款后可以获得一次活动抽奖机会。';

$_LANG['cfg_name']['draw_form'] = '抽奖形式';
$_LANG['cfg_range']['draw_form'][1] = '砸金蛋';
$_LANG['cfg_range']['draw_form'][2] = '刮刮卡';
$_LANG['cfg_range']['draw_form'][3] = '大转盘';
$_LANG['cfg_desc']['draw_form'] = '请在 微信管理  活动管理中编辑添加活动规则。并保证活动为开启状态';

$_LANG['cfg_name']['min_order_draw'] = '参与抽奖活动最小订单金额';
$_LANG['cfg_desc']['min_order_draw'] = '当客户订单金额达到参与抽奖活动最小订单金额时才能抽奖。';


$_LANG['cfg_name']['index_best_goods_num'] = '首页精品推荐展示商品数量';//20161225
