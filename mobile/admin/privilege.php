...
if ($_REQUEST['act'] == 'logout')
{
	...
	setcookie('YPCP[admin_id]',   '', 1,'/'.ADMIN_PATH.'/');
    setcookie('YPCP[admin_pass]', '', 1,'/'.ADMIN_PATH.'/');
    setcookie('YPCP[safecode]', '', 1,'/'.ADMIN_PATH.'/');//20170110 prince
...
elseif ($_REQUEST['act'] == 'signin')
{
    ...
    if ($row)
    {
        ...
        if (isset($_POST['remember']))
        {
            ...
            $time = gmtime() + 3600 * 24 * 365;
            setcookie('YPCP[admin_id]',   $row['user_id'],                            $time,'/'.ADMIN_PATH.'/');
            setcookie('YPCP[admin_pass]', md5($row['password'] . $_CFG['hash_code']), $time,'/'.ADMIN_PATH.'/');
            setcookie('YPCP[safecode]', md5(ADMIN_SAFECODE), $time,'/'.ADMIN_PATH.'/');//20170110 prince
