...
/* JS代码增加_start  By demo.coolhong.com 今天优品多商户系统 qq 120029121 */
...
/* JS代码增加_end  By demo.coolhong.com 今天优品多商户系统 qq 120029121 */
...
function checkOrder()
{
  var lastCheckOrder = new Date(document.getCookie('YP_LastCheckOrder'));
  var today = new Date();

  if (lastCheckOrder == null || today-lastCheckOrder >= NEW_ORDER_INTERVAL)
  {
    document.setCookie('YP_LastCheckOrder', today.toGMTString());
