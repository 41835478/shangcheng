 ...
 * ============================================================================
 * $Author: prince $
 * $Id: captcha_manage.php 17217 2017-04-01 06:29:08Z prince $
*/
...
if ($_REQUEST['act'] == 'save_config')
{
    ...
    $sql = "UPDATE " . $yp->table('ypmart_shop_config',1) . " SET value='$captcha' WHERE code='captcha'";
    $db->query($sql);
    $sql = "UPDATE " . $yp->table('ypmart_shop_config',1) . " SET value='$captcha_width' WHERE code='captcha_width'";
    $db->query($sql);
    $sql = "UPDATE " . $yp->table('ypmart_shop_config',1) . " SET value='$captcha_height' WHERE code='captcha_height'";
    $db->query($sql);
