 ...
 * ============================================================================
 * $Author: Prince $
 * $Id: lib_common.php 17146 2010-04-29 06:20:43Z Prince $
*/
...
function get_promotion_info($goods_id = '')
{
    ...
    $favourable = array();
    $sql = 'SELECT act_id, act_range, act_range_ext, act_name, start_time, end_time FROM ' . $GLOBALS['yp']->table('favourable_activity') . " WHERE start_time <= '$gmtime' AND end_time >= '$gmtime'";
    if(!empty($goods_id))
    {
...
/* 修改 by demo.coolhong.com 今 天 优 品 多 商 户 系 统 q q 1 2 0 0 2 9 1 2 1 增加一个参数 */
function get_package_goods($package_id, $package_attr_id='')
{

	//增加 By demo.coolhong.com 今天优品多商户系统 qq 120029121
	if ($package_attr_id)
	{
    ...
    $sql = "SELECT pg.goods_id, g.goods_name, pg.goods_number, p.goods_attr, p.product_number, p.product_id
            ...
            WHERE pg.package_id = '$package_id' $sql_package_attr_id "; //有修改 by demo.coolhong.com 今 天 优 品 多 商 户 系 统 q q 1 2 0 0 2 9 1 2 1 注意最后那个 $sql_package_attr_id
    if ($package_id == 0)
    {
