...
if($count > 0)
{
	$sql = "SELECT * FROM " . $GLOBALS['yp']->table('deposit') . " WHERE id = '$id' AND user_id = '" . $_SESSION['user_id'] . "'";
...
{
	$sql = "SELECT COUNT(*) FROM " . $GLOBALS['yp']->table('deposit') . " WHERE id = '$id' and user_id = '$user_id'";
