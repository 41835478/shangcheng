...
//            }
//        }
        $redis->set('cat_list',json_encode(get_categories_tree()),3600*24);
    }

    $categories=(array)json_decode($redis->get('cat_list'),true);
...
//    $smarty->assign('category',   $category);       // 分类列表
