 ...
 * ============================================================================
 * $Author: PRINCE $
 * $Id: lucky_buy.php 17217 2017-04-01 06:29:08Z PRINCE $
 */
...
elseif ($_REQUEST['act'] == 'view')
{
    ...
    {   
		...
		if($user_id>0){
			...
			$sql = "select count(*) from ". $GLOBALS['yp']->table('lucky_buy_detail') . " where  act_id='$act_id' and schedule_id='$schedule_id' and user_id='$user_id' ";
			$count_buy =$GLOBALS['db']->getOne($sql);
       		$smarty->assign('count_buy', $count_buy);
			//取出云购码
			$sql = "select * from ". $GLOBALS['yp']->table('lucky_buy_detail') . " where  act_id='$act_id' and schedule_id='$schedule_id' and user_id='$user_id' ORDER BY code ASC ";
...
elseif ($_REQUEST['act'] == 'schedule_view')
{
    ...
    {   
		...
		$sql = "select count(*) from ". $GLOBALS['yp']->table('lucky_buy_detail') . " where lucky_buy_id='$lucky_buy_id' and user_id=".$lucky_buy['lucky_user_id'];
		...
		if($user_id>0){
			//先取参与次数
			$sql = "select count(*) from ". $GLOBALS['yp']->table('lucky_buy_detail') . " where lucky_buy_id='$lucky_buy_id' and user_id='$user_id' ";
			$my_count_buy =$GLOBALS['db']->getOne($sql);
       		$smarty->assign('my_count_buy', $my_count_buy);
			//取出云购码
			$sql = "select * from ". $GLOBALS['yp']->table('lucky_buy_detail') . " where   lucky_buy_id='$lucky_buy_id' and user_id='$user_id' ORDER BY code ASC ";
...
elseif ($_REQUEST['act'] == 'buy')
{
    ...
    $cart = array(
        ...
        'is_shipping'    =>$lucky_buy['free_shipping']?:0,1,
