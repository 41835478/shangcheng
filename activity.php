 ...
 * QQ120029121 活动列表
 * ============================================================================
 * 演示地址: http://demo.coolhong.com  开发QQ:1200 29121    309485552
 * ============================================================================
 * $Author: PRINCE $
		...
		switch($row['act_type'])
		{
			case 0:
				...
				if(is_array($row['gift']))
				{
					...
					{
						$row['gift'][$k]['thumb'] = get_image_path($v['id'], $db->getOne("SELECT goods_thumb FROM " . $yp->table('goods') . " WHERE goods_id = '" . $v['id'] . "'"), true);
					}
				}
				break;
			case 1:
