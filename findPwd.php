 ...
 * ============================================================================
 * $Author: pr in ce $
 * $Id: findPwd.php 17217 2015-07-27 06:29:08Z pr in ce  $
 */
...
function action_check_username ()
{
	...
	$sql = "select user_id from " . $yp->table('users') . " where user_name = '" . $username . "'";
	...
	{
		$sql = "select user_id from " . $yp->table('users') . " where email='" . $username . "' AND supplier_id=0 ";
		$user_id = $db->getOne($sql);
		if($user_id)
		{
			// 用户名存在
	...
	{
		$sql = "select user_id from " . $yp->table('users') . " where mobile_phone='" . $username . "' AND supplier_id=0 ";
		$rows = $db->query($sql);
...
// 	$sql = "select user_id, user_name, email, mobile_phone from " . $yp->table('users') . " where user_id = '" . $user_id . "'";
// 	$row = $db->getRow($sql);
