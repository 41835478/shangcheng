...
*/
	...
	$sql="SELECT g.goods_id,g.shop_price,g.is_promote,g.promote_price,g.promote_start_date,g.promote_end_date FROM  ".$GLOBALS['yp']->table('goods')." AS g WHERE is_delete = '0' AND is_on_sale = '1' and g.goods_number >0 AND  g.goods_id IN ($goods_id_arr)";
